...
class MatchRightSidebar extends Component {
  state = {
    players: [
      {
        id: 1,
  ...
  render() {
    return (
      <div id="sidebar" className="rightSidebar">
        <div id="menu" className="rightMenu" style={{ padding: "0" }}>
          ...
          <span className="headline">
            STARTERS <span style={{ float: "right" }}>Pts</span>
          </span>
...
export default MatchRightSidebar;
