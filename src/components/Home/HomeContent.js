    ...
    return (
      <div id="content">
        <ul className="nav nav-tabs nav-justify" role="tablist">
          ...
          <li role="presentation">
            <a
              ...
              data-toggle="tab"
            >
              Scheduled <span className="color-gray hidden-xs">matches</span>
            </a>
          </li>
          <button type="button" className="calendar pull-right">
            <span className="hidden-xs">23.08</span>
          </button>
        </ul>
        <div className="tab-content">
              ...
              <section key={id}>
                ...
                <div className="match-wrap">
                  <div
                    ...
                    data-target={`#match-id-01-${item.country}`}
                    aria-expanded="false"
                  ...
                  >
                    ...
                    <div className="match-hdp">
                      <div className="match-h">
                        <span>0.88</span> <span>6.40</span>
                      </div>
                      <div className="match-d">
                        <span>-0.5/-1</span> <span>4.70</span>
                      </div>
                      <div className="match-p">
                        <span>0.96</span> <span>1.33</span>
                      </div>
                    </div>
                  </div>
                  <div
                ...
                <div className="match-wrap">
                  <div
                    className="match"
                    data-toggle="collapse"
                    data-target={`#match-id-02-${item.country}`}
                    aria-expanded="false"
                    aria-controls={`match-id-01-${item.country}`}
                  >
                    <div className="match-date">
                      23.08 20:45 <span className="match-live">Live</span>
                    </div>
                    <div className="match-clubs">
                      <div className="match-club-first">
                        <div className="match-club">
                ...
                <div className="match-wrap">
                  <div
                    className="match"
                    data-toggle="collapse"
                    data-target={`#match-id-03-${item.country}`}
                    aria-expanded="false"
          ...
          <div role="tabpanel" className="tab-pane" id="live">
            ...
          </div>
          <div role="tabpanel" className="tab-pane" id="finished">
            ...
          </div>
          <div role="tabpanel" className="tab-pane" id="scheduled">
            ...
          </div>
        </div>
      </div>
